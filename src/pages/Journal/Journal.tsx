...
import { getJournalData } from "../../firebase/getData";
...
function Row(props: { entry: JournalEntry }) {
  const { entry } = props;
          ...
          <TableHead>
            <TableRow>
              ...
              {/* <TableCell align="right">
                <Button variant="outlined" sx={{ backgroundColor: "black" }}>Add</Button>
              </TableCell> */}
            </TableRow>
          </TableHead>
          <TableBody>
            {entries &&
              entries.map((entry) => {
                return <Row key={entry.time} entry={entry} />;
              })}
          </TableBody>
        </Table>
      </TableContainer>
